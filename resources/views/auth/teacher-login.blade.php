...
@section('content')
<!-- BEGIN LOGIN FORM -->
<form class="login-form" method="POST" action="{{ route('teacher.login.submit') }}">
    {{ csrf_field() }}
    <h3 class="form-title font-green">Admin Connexion</h3>
    ...
    <div class="create-account">
        <p>
            <a href="javascript:;" id="forget-password" class="uppercase">Mot de passe oublié ?</a>
        </p>
    </div>
</form>
<!-- END LOGIN FORM -->
